...
export function UiButton({
  ...
  return (<button {...props} className={clsx(className, "px-4 h-10 rounded cursor-pointer flex gap-2 items-center justify-center transition-all", {
      ...
      outlined: "border border-slate-300 bg-slate-200 shadow-md hover:bg-slate-400 disabled:opacity-50"
    }[variant])}/>);
}
