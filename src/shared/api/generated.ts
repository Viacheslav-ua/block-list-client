...
export const blockListControllerAddItemToBlockList = (
...
export const blockListControllerRemoveItemFromBlockList = (
  id: number,
  options?: SecondParameter<typeof createInstance>,
) => {
  return createInstance<BlockItemDto>(
...
>;
export type BlockListControllerAddItemToBlockListResult = NonNullable<
  Awaited<ReturnType<typeof blockListControllerAddItemToBlockList>>
>;
export type BlockListControllerRemoveItemFromBlockListResult = NonNullable<
  Awaited<ReturnType<typeof blockListControllerRemoveItemFromBlockList>>
>;
